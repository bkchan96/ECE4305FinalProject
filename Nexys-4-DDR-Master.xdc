...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { dreset }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn

set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L9P_T1_DQS_14 Sch=btnc
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { tempreset }]; #IO_L4N_T0_D05_14 Sch=btnu
